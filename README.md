...
![Explainable AI](https://img.shields.io/badge/🔬_Explainable_AI-✅_Active-brightgreen)
![Multi-Agent Debate](https://img.shields.io/badge/🤝_Multi--Agent_Debate-✅_Active-brightgreen)
![RLHF](https://img.shields.io/badge/🔄_RLHF-✅_Self--Improving-brightgreen)
![Blockchain](https://img.shields.io/badge/⛓️_Blockchain-✅_Forensics-brightgreen)
![Real-time](https://img.shields.io/badge/🌊_Real--time-✅_Streaming-brightgreen)
![Observability](https://img.shields.io/badge/📊_Observability-✅_Prometheus-brightgreen)
...
- [Key Features](#-key-features)
  ...
  - [⛓️ Blockchain Forensics](#️-4-blockchain-forensics)
...
- ⛓️ **Blockchain Forensics** - Bitcoin, Ethereum, DeFi, NFT
...
- ⚡ **Ultra-fast processing** (45ms p50, 120ms p95)
- 🎨 **Modern React Dashboard** with D3.js visualizations

### 🚀 **Advanced Technologies (100% Implemented)**

- ⚙️ **Apache Kafka** - Real-time streaming
- ⚡ **Apache Spark** - Batch processing (100M+ transactions)
...
- 🕸️ **Neo4j** - Graph database for network analysis
- ⚡ **ClickHouse** - Ultra-fast analytics (1.2s for 100M rows)
- 🔄 **LangGraph** - State machines for multi-agent workflows
- 🎯 **DSPy** - Automatic prompt optimization
- 🎓 **LoRA Fine-tuning** - AML-specialized LLM
- 🕸️ **Graph Neural Networks (GNN)** - Deep learning on graphs
...
- 🎖️ **Learning to Rank** - Intelligent alert triage
- 📈 **Dynamic Thresholds** - Adaptive learning
- 🏛️ **FinCEN BSA E-Filing** - Automatic SAR submission
...
graph TB
    ...
    subgraph "🟣 LAYER 2: Enrichment"
        ...
        B2[👤 Customer Profile]
        B3[📋 Sanctions Check]
        B4[⚠️ PEP Verification]
        A3 --> B1 & B2 & B3 & B4
    end
    
    subgraph "🟢 LAYER 3: Multi-Agent Analysis"
        C1[📏 Rules Engine]
        C2[🤖 ML Behavioral]
        C3[🕸️ Network Analysis]
        C4[🔤 Semantic NLP]
        C5[🧠 LLM Orchestrator]
    ...
    subgraph "🟡 LAYER 4: Decision & Action"
        D1{Risk Score}
        D2[🚨 Create Alert]
        D3[📊 Monitor]
        D4[📝 Generate SAR]
    ...
    subgraph "🔴 LAYER 5: Intelligence & Learning"
        E1[📚 Vector DB]
        E2[💬 AI Chatbot]
        E3[🔄 Feedback Loop]
        D2 & D4 --> E1
...
- 🛤️ **Decision Path Tracing** - Complete decision path
- ⚖️ **Regulation Mapping** - FATF, FinCEN, BSA, OFAC
- 📝 **Immutable Audit Trail** - Complete record for regulators
- 🗣️ **Natural Language Explanations** - Explanations in natural language
...
sequenceDiagram
    ...
    participant P as ⚔️ Prosecutor
    participant D as 🛡️ Defender
...
- ⚔️ **Prosecutor** - Argues for suspicion
- 🛡️ **Defender** - Argues for legitimacy  
- 🔍 **Skeptic** - Critically questions both sides
- ⚖️ **Judge** - Balanced final verdict
...
- 🌪️ **Mixer Detection** - CoinJoin, Tornado Cash
- 🏦 **Exchange Tracking** - KYC trail identification
- 🕸️ **Cluster Analysis** - Address clustering
- 🌉 **Chain Hopping** - Cross-chain movements
- 💱 **DeFi Analysis** - Flash loans, wash trading
- 🖼️ **NFT Forensics** - Price manipulation, wash trades
...
### 🛡️ 7. Adversarial Testing & Model Robustness
...
graph TB
    ...
    subgraph "Alert Rules"
        L -->|Accuracy < 85%| M[🔴 ModelAccuracyDrop]
        L -->|P95 > 100ms| N[🟡 HighInferenceLatency]
        L -->|Drift > 0.3| O[🟠 DataDriftDetected]
        L -->|Errors > 5%| P[🔴 APIHighErrorRate]
        L -->|Lag > 1000| Q[🟡 KafkaConsumerLag]
        L -->|2x spike| R[🟠 TransactionSpike]
        M --> S[AlertManager]
        N --> S
        O --> S
        P --> S
    ...
    subgraph "Notification Channels"
        S --> T[📧 Email<br/>Compliance team]
        S --> U[💬 Slack<br/>ML team]
        S --> V[📟 PagerDuty<br/>DevOps on-call]
        S --> W[📱 SMS<br/>Critical alerts]
    end
...
- ⚖️ "What are FATF guidelines on PEPs?"
...
graph TB
    ...
    subgraph Features["🔬 Feature Engineering<br/>80+ Features"]
        BASIC[Basic: 10]
        ROUND[Roundness: 5]
        TYPE[Type: 8]
        GEO[Geographic: 6]
...
graph TB
    subgraph Sources["🌐 Official Sources"]
        OFAC[🇺🇸 OFAC<br/>US Treasury<br/>SDN List]
        UN[🌐 UN<br/>Security Council<br/>Consolidated List]
        EU[🇪🇺 EU<br/>Financial Sanctions<br/>Database]
    end
    
    subgraph Download["📥 Daily Download"]
    ...
    subgraph Check["✅ Real-time Check"]
        TXN[Transaction]
        MATCH[Name Matching]
        RESULT{Match?}
        ALERT[🚨 Create Alert]
...
- 📊 **Estatísticas**: Métricas por fonte disponíveis
...
### 🕸️ 17. Real Network Graph Analysis
...
graph TB
    ...
    subgraph Graph["🕸️ Graph Construction<br/>NetworkX"]
        BUILD[Build DiGraph]
...
**Análise de Rede Completa com NetworkX:**
...
graph TB
    ...
    subgraph "Validation"
        ...
        P --> Q{Valid?}
        Q -->|No| R[⚠️ Fix Errors<br/>Re-generate]
        R --> G
...
graph TB
    ...
    subgraph "Red Flag Detection"
        ...
        B --> C
        C -->|$5000/oz vs<br/>$1500-2500| D[⚠️ RED FLAG<br/>100% over market<br/>CRITICAL]
        
        A --> E{Origin/Dest<br/>High Risk?}
        E -->|Venezuela<br/>Sanctioned| F[⚠️ RED FLAG<br/>High-risk country]
        
        A --> G{Phantom<br/>Shipping?}
        G -->|Check BOL<br/>exists| H{Valid?}
        H -->|No| I[⚠️ RED FLAG<br/>No proof of shipment]
        H -->|Yes| J[✅ OK]
        
        A --> K{Multiple<br/>Invoicing?}
        K -->|Check<br/>duplicates| L{Found?}
        L -->|Yes| M[⚠️ RED FLAG<br/>Same transaction<br/>invoiced 2x]
        L -->|No| N[✅ OK]
    end
...
graph TB
    ...
    subgraph "AML Risk Analysis"
        ...
        L -->|High-risk| M[⚠️ Sanctioned<br/>Jurisdiction]
        
        G --> N{Amount<br/>Pattern?}
        N -->|Multiple < $10K| O[⚠️ STRUCTURING]
        N -->|> $100K| P[⚠️ Large Transfer<br/>Enhanced Due Diligence]
        
        K --> Q{Purpose<br/>Vague?}
        Q -->|Yes| R[⚠️ Suspicious<br/>Narrative]
        
        I --> S{Beneficiary<br/>Screening}
        S -->|PEP/Sanctions| T[⚠️ HIGH RISK<br/>Entity match]
    end
    ...
    subgraph "Network Analysis"
        ...
        W -->|> 3 banks| X[⚠️ LAYERING<br/>Obscuring origin]
    end
...
graph TB
    ...
    subgraph "AML Risk Detection"
        ...
        N -->|Yes| O[⚠️ STRUCTURING<br/>CTR Evasion]
        
        I --> P{Time<br/>< 6AM or > 10PM?}
        P -->|Yes| Q[⚠️ OFF-HOURS<br/>Suspicious timing]
        
        J --> R{MCC<br/>High Risk?}
        R -->|Casino/Crypto| S[⚠️ HIGH-RISK MCC]
        
        K --> T{Entry<br/>Mode?}
        T -->|Manual/Swipe| U[⚠️ NON-CHIP<br/>Higher fraud risk]
...
graph TB
    ...
    subgraph "CEP Matching"
        ...
        G -->|Structuring| H[⚠️ ALERT<br/>Same customer<br/>$9.5K × 3<br/>in 8 hours]
        G -->|Smurfing| I[⚠️ ALERT<br/>12 transactions<br/>$8K each<br/>Same beneficiary]
        G -->|Rapid| J[⚠️ ALERT<br/>$50K deposited<br/>Transferred in 5min]
        G -->|Layering| K[⚠️ ALERT<br/>Funds through<br/>7 intermediaries]
...
graph TB
    ...
    subgraph "Example Tracked"
        ...
        W[Run 3: Ensemble<br/>AUC 0.97 ⭐] --> X
...
graph TB
    ...
    subgraph "Pruning (Early Stopping)"
        ...
        J -->|Yes| K[Prune Trial<br/>Save Time ⚡]
        J -->|No| E
        K --> G
    end
    ...
    subgraph "Results"
        ...
        L --> M[Baseline AUC: 0.89<br/>Optimized AUC: 0.94<br/>+5.6% improvement ⭐]
    end
...
graph TB
    ...
    subgraph "Data Drift Detection"
        ...
        F --> G
        G -->|Yes| H[⚠️ ALERT<br/>Feature distribution<br/>changed significantly]
        G -->|No| I[✅ OK]
    end
    ...
    subgraph "Performance Monitoring"
        ...
        K -->|Accuracy -5%| L[⚠️ ALERT<br/>Model accuracy<br/>dropped to 0.87]
        K -->|FP rate +10%| M[⚠️ ALERT<br/>Too many false<br/>positives]
        K -->|OK| N[✅ OK]
    end
    ...
    subgraph "Prediction Drift"
        ...
        P -->|Yes| Q[⚠️ ALERT<br/>Model flagging 2x<br/>more transactions]
        P -->|No| R[✅ OK]
    end
...
- **Dashboards:**
  ...
  ├─ Accuracy: 0.89 (↓ from 0.92 last month) ⚠️
  ...
  🔄 Data Drift Report
  ├─ Amount: Drift detected (p=0.02) ⚠️
  ├─ Transaction type: Stable
  ├─ Country: Drift detected (p=0.01) ⚠️
  ├─ Time of day: Stable
...
flowchart TD
    ...
    PARALLEL --> NETWORK[🕸️ Network Analysis]
    ...
    STORE[(📚 Store in<br/>Vector DB)] --> END([🏁 Complete])
...
# 1️⃣ FASE 1: INGRESSO DE TRANSAÇÕES
print("=" * 80)
print("1️⃣ FASE 1: INGRESSO DE TRANSAÇÕES VIA KAFKA")
print("=" * 80)
...
# Cliente suspeito faz múltiplas transações (STRUCTURING)
...
# 2️⃣ PHASE 2: RULE ANALYSIS
print("\n" + "=" * 80)
print("2️⃣ PHASE 2: ANALYSIS WITH 50+ COMPLIANCE RULES")
print("=" * 80)
...
for txn in suspicious_transactions:
    ...
    if txn_violations:
        ...
        print(f"⚠️  {txn.transaction_id}: {len(txn_violations)} violations")

print(f"\n🚨 Total violations detected: {len(violations)}")

# 3️⃣ PHASE 3: MACHINE LEARNING (ENSEMBLE)
print("\n" + "=" * 80)
print("3️⃣ PHASE 3: ML ANALYSIS (XGBoost + LightGBM + CatBoost)")
print("=" * 80)
...
# 4️⃣ PHASE 4: NETWORK ANALYSIS (GRAPH)
print("\n" + "=" * 80)
print("4️⃣ PHASE 4: NETWORK ANALYSIS WITH NEO4J")
print("=" * 80)
...
# 5️⃣ FASE 5: SANCTIONS SCREENING
print("\n" + "=" * 80)
print("5️⃣ FASE 5: SCREENING CONTRA 15,000+ ENTIDADES SANCIONADAS")
print("=" * 80)
...
print(f"🔍 Cliente: {customer_result}")

if customer_result['hit']:
    print("🚨 ALERTA CRÍTICO: Cliente na lista de sanções!")

# 6️⃣ FASE 6: CONSOLIDAÇÃO E PRIORIZAÇÃO
print("\n" + "=" * 80)
print("6️⃣ FASE 6: CONSOLIDAÇÃO DE ALERTS E PRIORIZAÇÃO")
print("=" * 80)
...
print(f"🎖️  Alert rankeado com prioridade: {ranked_alerts[0][1]:.2f}")

# 7️⃣ PHASE 7: LLM ANALYSIS & SAR GENERATION
print("\n" + "=" * 80)
print("7️⃣ PHASE 7: LLM ANALYSIS & SAR GENERATION")
print("=" * 80)
...
# 8️⃣ PHASE 8: FILING & COMPLIANCE
print("\n" + "=" * 80)
print("8️⃣ PHASE 8: FILING PREPARATION")
print("=" * 80)
...
# 9️⃣ FASE 9: RESULTADOS FINAIS
print("\n" + "=" * 80)
print("9️⃣ FASE 9: RESUMO FINAL DO CASO")
print("=" * 80)
...
║                     📊 COMPLETE CASE                             ║
╠══════════════════════════════════════════════════════════════════╣
║ Cliente:              CUST-SUSPICIOUS-001                        ║
║ Transações:           {len(suspicious_transactions)} transações                                    ║
║ Valor Total:          ${sum(t.amount for t in suspicious_transactions):,.2f}                                 ║
║ Período:              24 horas                                   ║
║                                                                  ║
║ 🚨 DETECÇÕES:                                                    ║
...
### 🚀 Exemplos Rápidos por Funcionalidade

#### Exemplo 1: Detectar Structuring
...
#### Exemplo 3: Análise de Documento
...
### 🏗️ Data Engineering Pipeline (ULTRA-TÉCNICO)
...
### ⚖️ Compliance Framework (ULTRA-TÉCNICO)
...
%%{init: {'theme':'dark'}}%%
graph TB
    subgraph Latency["⏱️ Latência Média"]
        L1[Validação: 5ms]
        L2[Enrichment: 10ms]
        L3[Rules: 20ms]
        L4[ML Analysis: 50ms]
...
Este projeto é proprietário. Uso não autorizado é proibido.
...
- 🗄️ **[Neo4j Browser](http://localhost:7474)** - Graph database
