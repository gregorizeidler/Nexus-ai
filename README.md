...
![NEXUS AI Logo](docs/images/nexus-ai-logo.png)
...
# 1️⃣ PHASE 1: TRANSACTION INGESTION
print("=" * 80)
print("1️⃣ PHASE 1: TRANSACTION INGESTION VIA KAFKA")
print("=" * 80)
...
# 5️⃣ PHASE 5: SANCTIONS SCREENING
print("\n" + "=" * 80)
...
# 6️⃣ PHASE 6: CONSOLIDATION & PRIORITIZATION
print("\n" + "=" * 80)
...
║                     📊 COMPLETE CASE                             ║
╠══════════════════════════════════════════════════════════════════╣
║ Customer:             CUST-SUSPICIOUS-001                        ║
║ Transações:           {len(suspicious_transactions)} transações                                    ║
║ Total Amount:         ${sum(t.amount for t in suspicious_transactions):,.2f}                                 ║
║ Period:               24 hours                                   ║
║                                                                  ║
║ 🚨 DETECTIONS:                                                    ║
